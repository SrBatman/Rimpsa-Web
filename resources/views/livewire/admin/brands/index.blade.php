            ...
            <div class="row ">
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title" style="color: #fff;">Proovedor</h4>
                        <div class="breadcrumb-action justify-content-center flex-wrap">
                            <div class="action-btn">
                                <button type="button" class="btn btn-sm btn-primary btn-add btn-add-brand" data-toggle="modal" data-target="#addBrandModal">
                                    <i class="la la-plus"></i>Agregar Proovedor</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table mb-0 table-borderless" style="background: #313338;  color: #fff;">
                                        ...
                                        <tbody>
                                            @forelse ($brands as $brand)
                                                <tr>
                                                    <td><div class="userDatatable-content" style="color: #fff;">{{ $brand->id }}</div></td>
                                                    <td><div class="userDatatable-content" style="color: #fff;">{{ $brand->name }}</div></td>
                                                    <td>
