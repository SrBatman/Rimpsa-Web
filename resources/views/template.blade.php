			...
			<nav class="navbar navbar-expand-lg navbar-dark" aria-label="Ninth navbar example">
				<div class="container-xl">
					...
					<div class="social-container">
						...
						<span class="">
							<a class="" target="_blank" href="https://www.instagram.com/catmaqmx/">
		...
		<section class="top-second">
			<div class="top-second-container">
				<div class="icon-rimpsa-top">
					<img src="{{ asset('assets/imgs/logo_blanco_01.png') }}" alt="logo" height="76px" width="164">
				</div>
								...
								<ul class="navbar-nav">
									...
									<!-- <li class="nav-item dropdown">
										...
										<ul class="dropdown-menu" aria-labelledby="dropdown08">
											<li><a class="dropdown-item" href="#">Actiosn</a></li>
